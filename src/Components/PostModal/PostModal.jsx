...
function PostModal({handleClosePostModal,uid, id, image, video, time, userData, activity, likes, comments, title, handleLike, handleDeleteLike}){
    ...
    return (
        <div className="postDetailsCardContainer">
            ...
            <PictureCardComment comments={comments} postId={id}/>
           </div>
